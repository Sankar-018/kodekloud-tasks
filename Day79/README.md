...
Upgrade Jenkins plugins and Restart Jenkins
...
Create a pipeline job to install package:

Add parameters: HOSTNAME, USER, PASSWORD, PACKAGE
Pipeline script: copy-paste this jenkins File
...
Create a freestyle job for deployment:
